...
<body>
    ...
    <div class="container mt-5 table-container">
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                <a href="customer-insert.jsp" class="btn btn-outline-primary">Add </a>
            </div>
            <div class="col-md-4">
                <a href="customer-update.jsp" class="btn btn-outline-secondary">Update </a>
            </div>
            <div class="col-md-4">
                <a href="customer-delete.jsp" class="btn btn-outline-danger">Delete </a>
            </div>
        </div>
