...
<body>
    ...
    <div class="container">
        <h2 class="mb-4">Update Inventory Form</h2>
        <form action="inventoryControllerupdate" method="post">
            <div class="form-row">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="DaysOfSupply">Days of Supply</label>
                    <input type="number" class="form-control" id="DaysOfSupply" name="DaysOfSupply">
                </div>
                <div class="form-group col-md-6">
                    <label for="RecentSalesTrend">Recent Sales Trend</label>
                    <input type="text" class="form-control" id="RecentSalesTrend" name="RecentSalesTrend">
                </div>
            </div>
            <div class="form-group">
                <label for="MinimumStockLevel">Minimum Stock Level</label>
                <input type="number" class="form-control" id="MinimumStockLevel" name="MinimumStockLevel">
            </div>
