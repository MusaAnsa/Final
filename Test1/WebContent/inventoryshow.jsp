...
<body>
    ...
    <div class="container mt-5 table-container">
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                <a href="inventory-insert.jsp" class="btn btn-outline-primary">Add Item</a>
            </div>
            <div class="col-md-4">
                <a href="inventory-update.jsp" class="btn btn-outline-secondary">Update Item</a>
            </div>
            <div class="col-md-4">
                <a href="inventory-delete.jsp" class="btn btn-outline-danger">Delete Item</a>
            </div>
        </div>
