...
<body>
    ...
    <div class="container mt-5 table-container">
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                <a href="sales-insert.jsp" class="btn btn-outline-primary">Add Sales</a>
            </div>
            <div class="col-md-4">
                <a href="sales-update.jsp" class="btn btn-outline-secondary">Update Sales</a>
            </div>
            <div class="col-md-4">
                <a href="sales-delete.jsp" class="btn btn-outline-danger">Delete Sales</a>
            </div>
        </div>
